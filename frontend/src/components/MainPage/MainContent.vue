  ...
  <div class="main" :class="{ fullscreen: isFullscreen }">
    ...
    <div class="timer">
      ...
      <div
        ...
        :style="
          phase === 'focus'
            ? { '--focus-shadow': `0 0 14px ${hexToRgba(selectedCategoryColor, 0.45)}` }
            : {}
        "
      >
...
const { minutesStr, secondsStr, phase, isFullscreen } = storeToRefs(timerStore)
...
.mode-indicator.focus {
  ...
  box-shadow: var(--focus-shadow, 0 0 14px rgba(0, 123, 255, 0.4));
}
